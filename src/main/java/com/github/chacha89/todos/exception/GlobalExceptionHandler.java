...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<APIResponse<Void>> handleLoginMemberNotFoundException()
    {
    ...
    public ResponseEntity<APIResponse<Void>> handleLoginInvalidPasswordException()
    {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(APIResponse.fail(400,"아이디 또는 비밀번호가 일치하지 않습니다."));
    }
    ...
    public ResponseEntity<APIResponse<Void>> handleMissingSearchTermException()
